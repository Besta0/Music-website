...
<div class="bg">
    <div class="signUp">
        ...
        <el-form :model="registerForm" ref="registerForm" label-width="70px" class="demo-ruleForm" :rules="rules">
            ...
            <div class="login-btn">
                <el-button @click="goback(-1)" style="font-size: 20px;"><i class="iconfont icon-r-left" style="font-size: 22px;"></i> 取消</el-button>
                <el-button type="primary" @click="SignUp" style="font-size: 20px;"><i class="iconfont icon-r-yes" style="font-size: 22px;"></i> 确定</el-button>
            </div>
        </el-form>
    </div>
</div>
...
.bg{
  background:url("../../static/bg.png") no-repeat 5px 5px;
  width:100%;
  height:100%;
